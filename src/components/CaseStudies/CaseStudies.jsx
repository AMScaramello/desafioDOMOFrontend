...
export const CaseStudies = () => {
	return (
		<div className="caseStudiesContainer" id="CaseStudies">
			<div className="text-center pb-5 caseStudiesSubcontainer1">
				<h5 className="caseStudiesTitle mb-3">CLIENTS WE WORKED WITH</h5>
				<div className="col pt-5">
					<div className="row justify-content-between caseStudiesSubcontainerLogos">
						{icons.map((icon) => (
							<div key="" className="col caseStudiesContainerLogo">
			...
			<div className="row justify-content-between caseStudiesContainesCards">
				{cards.map((card) => (
					<div className="col mx-3 caseStudiesContainerCard" key="">
						<div className="row px-4 py-5 caseStudiesCard">
							<div className="col-7 caseStudiesCardContainerText">
								<div className="card-body caseStudiesCardBody">
